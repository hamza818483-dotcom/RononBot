...
async def process_pdf(update: Update, context: ContextTypes.DEFAULT_TYPE, channel_id, csv_only: bool = False, status_message=None, pdf_only: bool = False, both_only: bool = False):
    ...
    try:
        ...
        if all_mcqs_csv and (csv_only or both_only):
            csv_buf = io.StringIO()
        ...
        if all_mcqs_csv and (pdf_only or both_only):
            mcqs_for_pdf = [
        ...
        if not csv_only and not pdf_only and not both_only and summary_pages:
